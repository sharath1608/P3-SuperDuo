...
public class Utilies
{
    ...
    public static String getLeague(int league_num,Context ctx)
    {
        switch (league_num)
        {
            ...
            default: return ctx.getString(R.string.unknown_league);
        }
    }
    ...
    public static DateTime getDateTime(String dateString, String pattern,Context ctx){
    ...
    public static boolean isRTL(Context ctx){
        ...
        return (directionality == Character.DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC||
